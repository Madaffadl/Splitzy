...
export const id = {
  ...
  app: {
    ...
    // Ulasan produk dari user. Namanya `feedback`, bukan `review`, karena
    // `review` di atas sudah dipakai alur persetujuan perubahan trip.
    feedback: {
      cardTitle: "Bagaimana pengalamanmu?",
      cardSubtitle: "Ceritakan pendapatmu tentang Splitzy.",
      inlineTitle: "Splitzy membantu?",
      inlineSubtitle: "Beri rating singkat — cukup sekali.",
      ratingLabel: "Berapa bintang untuk Splitzy?",
      // Lima kunci datar, bukan array: `typeof id` menyimpulkan array literal
      // sebagai string[], jadi en.ts bisa mengirim empat label dan tsc diam saja.
      star1: "1 dari 5 bintang",
      star2: "2 dari 5 bintang",
      star3: "3 dari 5 bintang",
      star4: "4 dari 5 bintang",
      star5: "5 dari 5 bintang",
      bodyLabel: "Ceritakan sedikit",
      bodyPlaceholder: "Apa yang paling membantu? Apa yang bisa lebih baik?",
      bodyOptional: "opsional",
      submit: "Kirim ulasan",
      submitting: "Mengirim…",
      cancel: "Batal",
      notNow: "Nanti saja",
      ...
      submittedBody: "Ulasanmu sudah kami terima.",
      submitFailed: "Gagal mengirim",
      submitFailedBody: "Coba lagi sebentar lagi.",
      ratingRequired: "Pilih bintangnya dulu.",
      statusPending: "Menunggu ditinjau",
      statusApproved: "Ulasanmu sudah disetujui",
      statusRejected: "Ulasanmu belum bisa ditampilkan",
      rejectedNote: "Catatan dari tim: “{note}”",
      editWarning: "Mengubah ulasan membuatnya ditinjau ulang.",
