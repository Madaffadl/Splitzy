    ...
    theme: {
        extend: {
            colors: {
                ...
                // Status tokens. `text-success` replaces the hand-written
                // `text-emerald-600 dark:text-emerald-400` pair that appeared
                // ~100 times; the theme switch is handled once, in globals.css.
                success: {
